...
module internal AccountCommandHandler =
    ...
    let private createAccount (command: CreateAccountCommand) (_, state) =
        logger.Information("Creating account {AccountName}", command.Name)
        ...
        | Account.Init ->
            ...
            logger.Information("Created account {AccountName}", command.Name)
        ...
        | Account.Deleted _ ->
            logger.Information("Cannot create account {AccountName}, it already exists", command.Name)
