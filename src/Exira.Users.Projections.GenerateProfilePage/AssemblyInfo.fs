...
[<assembly: AssemblyVersionAttribute("0.4.38")>]
[<assembly: AssemblyFileVersionAttribute("0.4.38")>]
[<assembly: AssemblyMetadataAttribute("githash","d5f2ffa3f5c967ca9d38719fa0dacb3ba89afc80")>]
do ()

module internal AssemblyVersionInformation =
    let [<Literal>] Version = "0.4.38"
