...
[<assembly: AssemblyVersionAttribute("0.4.44")>]
[<assembly: AssemblyFileVersionAttribute("0.4.44")>]
[<assembly: AssemblyMetadataAttribute("githash","2e8bfbd9bf654fd292bd3b4ee05a146df380bc79")>]
do ()

module internal AssemblyVersionInformation =
    let [<Literal>] Version = "0.4.44"
