...
[<assembly: AssemblyVersionAttribute("0.4.41")>]
[<assembly: AssemblyFileVersionAttribute("0.4.41")>]
[<assembly: AssemblyMetadataAttribute("githash","2241b2a55abbac3a7611248a0ed96da2d586824a")>]
do ()

module internal AssemblyVersionInformation =
    let [<Literal>] Version = "0.4.41"
